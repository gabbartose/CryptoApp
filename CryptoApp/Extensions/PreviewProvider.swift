...
class DeveloperPreview {
    ...
    let statisticModel1 = StatisticModel(title: "Market Cap", value: "$12.5BM", percentageChange: 25.34)
    let statisticModel2 = StatisticModel(title: "Total Volume", value: "$1.23Tr")
    let statisticModel3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.30)
}
